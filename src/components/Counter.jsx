...
class Counter extends Component {
  ...
  saveTimer() {
    clearInterval(this.intervalId);
    const {
      timesList, seconds, minutes, categoryId,
    } = this.state;
    const newId = timesList.slice(-1)[0].id + 1;
  ...
  render() {
    const {
      showPause, showStart, showStop, showResume, showSave,
      zMinutes, zSeconds, seconds, minutes,
    } = this.state;
    return (
      <>
